...
# Here are some examples to help you understand how to generate appropriate search queries to better collect online information:
# ---
...
# step by step search querys:
# {{"query": "year of telephone invention"}}
# {{"query": "year American Civil War ended"}}
# {{"query": "year Eiffel Tower established"}}

# ---
# Question: "Which country has a higher population density: Japan or India?"

# step by step search querys:
# {{"query": "population and area of Japan"}}
# {{"query": "population and area of India"}}

# ---
# Question: "Which country has won more total Olympic gold medals: the United States or China?"

# step by step search querys:
# {{"query": "total Olympic gold medals won by the United States"}}
# {{"query": "total Olympic gold medals won by China"}}

# ---
# Question: "Who discovered the structure of DNA, and in which year was the discovery made?"

# step by step search querys:
# {{"query": "scientists who discovered DNA structure"}}
# {{"query": "year DNA structure discovered"}}

# ---
# Question: "How many meters taller is the Burj Khalifa compared to the Empire State Building?"

# step by step search querys:
# {{"query": "height of Burj Khalifa"}}
# {{"query": "height of Empire State Building"}}

# ---
# Question: "Which country launched the first satellite into space, and what was the name of the satellite?"

# step by step search querys:
# {{"query": "first satellite launched into space"}}
# {{"query": "name of first satellite in space"}}

# ---

# Note that these examples are only for your reference when generating queries for calling the GoogleSearch tool. You don't need to follow their output format.
