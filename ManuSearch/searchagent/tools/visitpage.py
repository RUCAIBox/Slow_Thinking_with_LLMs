...
class VisitPage(BaseTool):
    ...
    def _execute(self, url, title, webpage_cache):
        ...
        if response.status_code == 200:
            ...
            serper_api_key = 'cb0d28279a826d7e5cf22d71f683c77ffd4ba27d'
        ...
        try:
            date = find_date(response.content)  # 设置超时
        except Exception as e:
            date = ""
    ...
    def parse_pdf(self, response):
        try:
            ...
            print(f"PDF处理错误: {str(e)} :{response.url}")
            return 
    ...
    def parse_docx(self, response):
        ...
        try:
            ...
            print(f"DOCX解析失败: {response.url} - {str(e)}")
            return 
    ...
    def parse_excel(self, response):
        ...
        try:
            ...
            print(f"Excel解析失败: {response.url} - {str(e)}")
            return 
